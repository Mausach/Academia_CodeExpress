    ...
    <div className="d-flex align-items-center justify-content-center customHeigth ">
      ...
      <img className="logo" style={{ width: '300px' }} src={Logo} alt="Logo" />{' '}
        ...
        <Form.Group className="mb-3" controlId="formGroupEmail">
          ...
          <Form.Control className="custom-input" type="email" placeholder="email"  name="email" value={user.email}
        ...
        <Form.Group className="mb-3" controlId="formGroupPassword">
          ...
          <Form.Label   className="text-white"></Form.Label>
          <Form.Control className="custom-input" type="password" placeholder="Contraseña" name="password" value={user.password} 
          onChange={onInputChange}/>
          <div className="pt-3">
